...
--
-- Host: localhost:3306
-- Generation Time: Dec 10, 2020 at 07:22 PM
...
(0, 'Bonhomme', 'L’archéologue Markus Muller spécialisée dans les pyramides égyptiennes a été assassiné : explorez les alentours pour trouver des indices !\r\n<p id =\'indice_texte\' style=\'text-align:center;\'><button class = \'bouton_indice\'>Indice</button> </p>', '<p>Zoomez pour trouver le corps de l\'archéologue.</p>', 47.8625, 13.1259, 'img/bonhomme2.png', 68, 150, 'music/zapsplat_horror_stab_dark_scary_cinematic_004_11803.mp3', 1, 5, 1, NULL, 1, NULL, NULL),
(1, 'Cadavre', 'Vous trouvez le corps de Markus Muller dans son salon. Il a probablement été empoisonné.\r\n\r\n<p id =\'indice_texte\' style=\'text-align:center;\'><button class = \'bouton_indice\'>Indice</button> </p>', '<p>Explorez les environs.</p>', 47.8625, 13.1254, 'img/cadavre2.png', 200, 63, 'music/zapsplat_horror_stab_dark_scary_cinematic_004_11803.mp3', 1, 14, 0, NULL, 2, NULL, NULL),
...
(3, 'Poste de police', 'Un agent de police vous donne le code pour accéder aux images de la caméra.', '', 47.865, 13.1254, 'img/police2.png', 150, 79, 'music/zapsplat_horror_stab_dark_scary_cinematic_004_11803.mp3', 1, 17, 0, NULL, 4, NULL, NULL),
...
(7, 'Aéroport', 'Une femme correspondant à celle des images de surveillance à pris l’avion pour l’Egypte la nuit du meurtre. Vous la retrouverez peut-être là-bas.\r\n\r\n<p id =\'indice_texte\' style=\'text-align:center;\'><button class = \'bouton_indice\'>Indice</button> </p>', '<p>Utiliser votre billet pour prendre l\'avion.</p>', 47.7942, 13.0012, 'img/avion2.png', 300, 75, 'music/zapsplat_horror_stab_dark_scary_cinematic_004_11803.mp3', 5, 16, 0, NULL, 9, NULL, 6),
(8, 'Madame', 'Bravo ! Vous avez retrouvé la meurtrière !', '', 29.9773, 31.1303, 'img/madame.jpg', 100, 100, 'music/zapsplat_horror_stab_dark_scary_cinematic_004_11803.mp3', 6, 7, 0, NULL, NULL, NULL, NULL),
...
(12, 'Antiquaire 3', 'Faites attention si vous ne trouvez pas rapidement les autres vases canope, l\'antiquaire risque de refuser de vous aider.', '', 30.1123, 31.397, 'img/antiquaire3.png', 129, 111, NULL, 5, 14, 0, NULL, 13, NULL, 16),
(13, 'Antiquaire 4', 'Bravo vous avez retrouvé tous les vases. L\'antiquaire vous indique qu\'il a entendu la femme demander comment se rendre aux pyramides qui se situent à l\'est de la ville.', '', 30.1123, 31.397, 'img/antiquaire4.png', 151, 111, NULL, 1, 14, 0, NULL, 8, NULL, NULL),
(14, 'Vase chacal', 'Votre inventaire est plein. Résolvez les énigmes précédentes pour pouvoir récupérer cette objet.', '', 30.1246, 31.361, 'img/vase_renard.png', 126, 167, NULL, 4, 15, 1, NULL, NULL, NULL, NULL),
